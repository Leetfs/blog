...
現在大学生で、中国科学院ソフトウェア研究所でインターン中です。主にRISC-V、基盤ソフトウェアとシステムの方向に注目しています。Project Trans、開往 travellings、aboutTransなどのオープンソースプロジェクトで活躍しています。

私の[履歴書](./resume)をご覧になり、私についてもっと知ってください。
