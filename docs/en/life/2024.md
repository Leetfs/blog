...
2. refactor: 更新AppFooter.vue组件 [#408](https://github.com/project-trans/RLE-wiki/pull/408)
3. refactor: 优化部署文档工作流 [#410](https://github.com/project-trans/RLE-wiki/pull/410)
4. 新增字数和预计阅读时间、文档两端对齐，优化作者信息显示逻辑 [#411](https://github.com/project-trans/RLE-wiki/pull/411)
5. refactor: 优化AppFooter.vue组件 [#413](https://github.com/project-trans/RLE-wiki/pull/413)
6. 重构 ReadingTime.vue 和 config.ts 以获取更准确的文档字数 [#414](https://github.com/project-trans/RLE-wiki/pull/414)
7. 修复历史记录显示错误 [#425](https://github.com/project-trans/RLE-wiki/pull/425)
8. 添加部署 PR 到 Cloudflare Pages 的工作流 [#428](https://github.com/project-trans/RLE-wiki/pull/428)
9. 修复 frontmatter 数据没有在页面切换时正确更新的 bug [#431](https://github.com/project-trans/RLE-wiki/pull/431)
10. refactor: 更新主题包并部署到 Cloudflare Pages [#432](https://github.com/project-trans/RLE-wiki/pull/432)
11. 添加了 draft 时不部署和使用 path 进行选择性部署 [#433](https://github.com/project-trans/RLE-wiki/pull/433)
12. 更新部署指南和构建流程 [#435](https://github.com/project-trans/RLE-wiki/pull/435)
13. refactor: 更新 RLE.wiki 主题配置 [#436](https://github.com/project-trans/RLE-wiki/pull/436)
14. refactor(config): update RLE.wiki theme configuration [#438](https://github.com/project-trans/RLE-wiki/pull/438)
15. fix: 修复 GitHub 编辑链接 [#439](https://github.com/project-trans/RLE-wiki/pull/439)
16. fix(config): 修复 sitePattern 的路径错误 [#440](https://github.com/project-trans/RLE-wiki/pull/440)
17. ci: 优化评论逻辑 [#448](https://github.com/project-trans/RLE-wiki/pull/448)
18. (.editorconfig)/ci: 调整格式规则，优化ci [#450](https://github.com/project-trans/RLE-wiki/pull/450)
19. ci: 确保草稿下的 PR 也能预览 [#452](https://github.com/project-trans/RLE-wiki/pull/452)
...
3. ci: 优化评论逻辑，移除没用的 /zh-cn/ 后缀，修改 baseURL [#1146](https://github.com/project-trans/MtF-wiki/pull/1146)
4. ci: 优化ci [#1151](https://github.com/project-trans/MtF-wiki/pull/1151)
5. fix: 修复构建错误 [#1188](https://github.com/project-trans/MtF-wiki/pull/1188)
6. ci: 改为使用 GitHub 构建 [#1201](https://github.com/project-trans/MtF-wiki/pull/1201)
7. ci: 修复触发条件 [#1209](https://github.com/project-trans/MtF-wiki/pull/1209)
8. ci: 改用 wrangler-action@v3 [#1223](https://github.com/project-trans/MtF-wiki/pull/1223)
...
2. feat: 添加自定义版权区内组织名的功能 [#7](https://github.com/project-trans/vitepress-theme-project-trans/pull/7)
3. fix(CopyrightInfo): 修复显示bug [#8](https://github.com/project-trans/vitepress-theme-project-trans/pull/8)
4. feat(nav): 添加导航栏切换字体功能 [#9](https://github.com/project-trans/vitepress-theme-project-trans/pull/9)
5. fix: 修复字体错误 [#10](https://github.com/project-trans/vitepress-theme-project-trans/pull/10)
6. style: 更改字体效果，格式化 fontSwitcher.js [#11](https://github.com/project-trans/vitepress-theme-project-trans/pull/11)
7. feat: 支持自定义文档属性栏 [#12](https://github.com/project-trans/vitepress-theme-project-trans/pull/12)
...
2. 添加通过 frontmatter 中的 order 字段 控制文档排序的功能 [#2](https://github.com/project-trans/vitepress-theme-project-trans/issues/2)
3. bug: Some articles can't be crawled [#53](https://github.com/jooooock/wechat-article-exporter/issues/53)
4. ios下切换到宋体不可用 [#13](https://github.com/project-trans/vitepress-theme-project-trans/issues/13)
